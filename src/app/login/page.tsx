        ...
        <div className="mx-auto w-full max-w-sm lg:max-w-md">
          ...
          <div className="space-y-3 mb-6">
            ...
            <div className="relative">
              <button
                disabled
                className="w-full flex items-center justify-center px-4 py-3 border border-gray-200 rounded-lg shadow-sm bg-gray-50 text-gray-400 cursor-not-allowed"
              >
              ...
              <span className="absolute -top-2 right-2 bg-gray-200 text-gray-500 text-xs font-medium px-2 py-0.5 rounded-full">
                Coming soon
              </span>
            </div>
          </div>
