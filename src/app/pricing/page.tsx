  ...
  const plans = [
    {
      ...
      limitations: ['Custom greeting', 'Custom call routing', 'AI SMS conversations', 'CRM integration'],
      popular: false,
    ...
    },
    {
      ...
      limitations: ['AI SMS conversations', 'Custom voice selection', 'API access'],
      popular: true,
