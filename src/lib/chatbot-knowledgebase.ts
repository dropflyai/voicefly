  ...
  subscriptionFeatures: {
    starter: {
      ...
      features: [
        ...
        "🎯 25 AI-researched leads/month (with auto-campaigns)",
        "👥 100 customers max",
        "🛠️ 5 services max",
    ...
    professional: {
      ...
      features: [
        ...
        "🎯 100 AI-researched leads/month (with auto-campaigns)",
        "👥 2,000 customers max",
        "🛠️ 50 services max",
        ...
        "✅ Automated lead nurturing (email→voice campaigns)",
        "✅ Custom branding (logo & colors)",
        "✅ Loyalty program (40% better retention)",
        "✅ GEO optimization tools (AI-powered visibility in ChatGPT, Perplexity, Claude)",
    ...
    enterprise: {
      ...
      features: [
        ...
        "🎯 500 AI-researched leads/month (with auto-campaigns)",
        ...
        "🤖 Advanced lead automation (Enterprise exclusive)",
